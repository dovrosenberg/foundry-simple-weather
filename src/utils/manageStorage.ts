// class for managing the file storage where we keep track of all of the past dates for which we've generated weather

//import SETTINGS from "../../../common/Settings";

// export interface SWWeatherArchiveEntry {
// 	date: number;
// 	version: string;   // the version ID of the simple-weather app that generated the weather (so we know if it's safe to use the values)
// 	climate: ___;
// 	weatherBox: ___;
// }
