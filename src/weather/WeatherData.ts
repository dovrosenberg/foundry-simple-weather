...
import { SimpleCalendarDate } from '@/calendar';
...
export class WeatherData {
  public date: SimpleCalendarDate | null;
  ...
  constructor(date: SimpleCalendarDate | null, season: Season | null, humidity: Humidity | null, climate: Climate | null, hexFlowerCell: HexFlowerCell | null, temperature: number | null) {
    this.date = date;
    this.season = season;
