...
export class ModuleSettings {
  ...
  private static menuParams: (ClientSettings.PartialSettingSubmenuConfig & { settingID: ModuleSettingKeys })[] = [
    ...
    // },
    {
      ...
      name: 'swr.settings.customWeather',
      label: 'swr.settings.customWeatherButton',
      hint: 'swr.settings.customWeatherHelp',
  ...
  private static displayParams: (ClientSettings.PartialSettingConfig & { settingID: ModuleSettingKeys })[] = [
    {
      ...
      name: 'swr.settings.outputWeatherToChat',
      hint: 'swr.settings.outputWeatherToChatHelp',
      default: true,
      type: Boolean,
    },
    {
      settingID: ModuleSettingKeys.outputDateToChat,
      name: 'swr.settings.outputDateToChat',
      hint: 'swr.settings.outputDateToChatHelp',
      default: false,
      type: Boolean,
    },
    {
      settingID: ModuleSettingKeys.publicChat,
      name: 'swr.settings.publicChat',
      hint: 'swr.settings.publicChatHelp',
      default: true,
      type: Boolean,
    },
    {
      settingID: ModuleSettingKeys.dialogDisplay, 
      name: 'swr.settings.dialogDisplay',
      hint: 'swr.settings.dialogDisplayHelp',
      default: true,
      type: Boolean,
    },
    {
      settingID: ModuleSettingKeys.useFX, 
      name: 'swr.settings.useFX',
      hint: 'swr.settings.useFXHelp',
      requiresReload: true,   
      type: String,
      choices: {  
    ...
    },
    {
      ...
      name: 'swr.settings.FXByScene',
      hint: 'swr.settings.FXBySceneHelp',
      requiresReload: true,     
      type: Boolean,
      default: false,
    },
    {
      ...
      name: 'swr.settings.attachToCalendar',
      hint: 'swr.settings.attachToCalendarHelp',
      default: false,
      requiresReload: true,    
      type: Boolean,
    },
    {
      ...
      name: 'swr.settings.storeInSCNotes',
      hint: 'swr.settings.storeInSCNotesHelp',
      default: false,
    ...
    },
    {
      ...
      name: 'swr.settings.useForecasts',
      hint: 'swr.settings.useForecastsHelp',
      default: false,
      requiresReload: true,    
      type: Boolean,
    },
    {
      ...
      name: 'swr.settings.playSound',
      hint: 'swr.settings.playSoundHelp',
      default: true,
      requiresReload: true,
      type: Boolean,
    },
    {
      ...
      hint: 'swr.settings.soundVolumeHelp',
      default: 0.5,
      requiresReload: true,
  ...
  private static localDisplayParams: (ClientSettings.PartialSettingConfig & { settingID: ModuleSettingKeys })[] = [
    {
      ...
      name: 'swr.settings.useCelsius',
      hint: 'swr.settings.useCelsiusHelp',
      default: false,
      type: Boolean,
    },
  ];
